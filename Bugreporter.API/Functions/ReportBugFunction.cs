...
public class ReportBugFunction
{
    ...
    public async Task<IActionResult> Run(
        ...
        Core.Features.ReportBug.ReportBugRequest req
    )
    {
        try
        {
            ...
            Core.Features.ReportBug.ReportBugRequest? reportBugRequest =
                JsonSerializer
                    .Deserialize<Core.Features.ReportBug.ReportBugRequest>(
                        reqBody,
            ...
            {
                newBug = new NewBug(
                    reportBugRequest.Summary, reportBugRequest.Description
                );
            ...
            ReportedBug reportedBug =
                await _createGitHubIssueCommand.Execute(newBug);
